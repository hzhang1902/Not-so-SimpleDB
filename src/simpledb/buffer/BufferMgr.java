...
public class BufferMgr {
   ...
   /**
    * CS4432-Project1: Creates a new buffer manager with specified replacement
    * policy, having the specified number of buffers.
   ...
   public BufferMgr(int numbuffers, String replacementPolicy) {
       if (replacementPolicy == null) {
           System.out.println("basic buffer replacement policy");
           bufferMgr = new BasicBufferManager(numbuffers);
       } else if (replacementPolicy.equals("-c")) {
           System.out.println("clock buffer replacement policy");
           bufferMgr = new ClockBufferManager(numbuffers);
       } else if (replacementPolicy.equals("-l")) {
           System.out.println("LRU buffer replacement policy");
           bufferMgr = new LRUBufferManager(numbuffers);
       }
   }
