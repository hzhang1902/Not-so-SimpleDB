...
public class Buffer {
   ...
   /**
    * CS4432-Project1: Creates a new buffer by given id
    * {@link simpledb.file.Page page}.  
    * This constructor is called exclusively by the 
    * class {@link BasicBufferManager}.
    * It depends on  the 
   ...
   Block assignToNew(String filename, PageFormatter fmtr) {
    ...
    /**
     * CS4432-Project1: check if this buffer is dirty
   ...
   public String toString() {
       String s =  ""+this.id+": pin: "+this.pins+
               " dirty: "+this.isDirty()+
               " block: ";
       if (this.block()!=null){
