...
public class DatabaseQueryTest {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("select name and graduation year from students in cs major.");
            String major = "compsci";
            s="select sname, gradyear "
                    + "from student, dept "
                    + "where did = majorid "
                    + "and dname = '" + major + "'";
            ...
            System.out.println("change cs majors to drama major.");
            s="update STUDENT set majorid=30 "
                    + "where majorid = 10";
            stmt.executeUpdate(s);
            ...
            major = "drama";
            System.out.println("select name and graduation year from students in drama major.");
            s="select sname, gradyear "
                    + "from student, dept "
                    + "where did = majorid "
                    + "and dname = '" + major + "'";
            ...
            System.out.println("delete student lee");
            s="delete from STUDENT where sname = 'lee'";
            stmt.executeUpdate(s);

            System.out.println("select name and graduation year from students.");
            s="select sname, gradyear "
                    + "from student";
            rs = stmt.executeQuery(s);
            while (rs.next()) {
